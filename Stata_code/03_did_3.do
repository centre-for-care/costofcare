 ...
 *****INDIVIDUAL INCOME
  *low_intensity 
 csdid ind_inc_deflated male dvage married asian black mixed  white  intermediate_education advanced_education employed_d hhsize weight_yearx, ivar(pidp) time(year) gvar(first_low_intensity_ok) method(drimp )
...
*medium low_intensity
  csdid ind_inc_deflated male dvage married asian black mixed  white  intermediate_education advanced_education employed_d hhsize weight_yearx, ivar(pidp) time(year) gvar(first_medium_low_intensity_ok) method(drimp )
...
*medium high_intensity
  csdid ind_inc_deflated male dvage married asian black mixed  white  intermediate_education advanced_education employed_d hhsize weight_yearx, ivar(pidp) time(year) gvar(first_medium_high_intensity_ok) method(drimp )
 ...
 *high intensity
   csdid ind_inc_deflated male dvage married asian black mixed  white  intermediate_education advanced_education employed_d hhsize weight_yearx, ivar(pidp) time(year) gvar(first_high_intensity_ok) method(drimp )
 ...
 ****HOUSEHOLD INCOME
   *low_intensity 
 csdid hh_inc_deflated male dvage married asian black mixed  white  intermediate_education advanced_education employed_d hhsize weight_yearx, ivar(pidp) time(year) gvar(first_low_intensity_ok) method(drimp )
  estat event, wboot estore(event5)  window(-8 6)
 csdid_plot, name(h1,replace) title("Low Intensity") graphregion(fcolor(white))
*medium low_intensity
  csdid hh_inc_deflated male dvage married asian black mixed  white  intermediate_education advanced_education employed_d hhsize weight_yearx, ivar(pidp) time(year) gvar(first_medium_low_intensity_ok) method(drimp )
   estat event, wboot estore(event6) window(-8 6)
 csdid_plot, name(h2,replace) title("Medium Low Intensity") graphregion(fcolor(white))
*medium high_intensity
  csdid hh_inc_deflated male dvage married asian black mixed  white  intermediate_education advanced_education employed_d hhsize weight_yearx, ivar(pidp) time(year) gvar(first_medium_high_intensity_ok) method(drimp )
 ...
 *high intensity
   csdid hh_inc_deflated male dvage married asian black mixed  white  intermediate_education advanced_education employed_d hhsize weight_yearx, ivar(pidp) time(year) gvar(first_high_intensity_ok) method(drimp )
